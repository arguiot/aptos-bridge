...
const WBTC_ADDRESS = {
  ...
  // FANTOM not supported
  // [ChainId.FANTOM]: '0x4385588ceb7cE866F871a8fb83898DC14089f359',
  [ChainId.APTOS]: `${BRIDGE_DEPLOY_ACCOUNT}::asset::${CoinType.WBTC}`,
} as const;
...
export const BRIDGE: AptosBridgeConfig = {
  tokens: [
    ...
    new Token(ChainId.BSC, USDC_ADDRESS[ChainId.BSC], 18, 'USDC', 'USD Coin'),
    ...
    // WBTC
    new Token(ChainId.ETHEREUM, WBTC_ADDRESS[ChainId.ETHEREUM], 8, 'WBTC', 'Wrapped BTC'),
    // FANTOM not supported
    // new Token(ChainId.FANTOM, WBTC_ADDRESS[ChainId.FANTOM], 8, 'WBTC', 'Wrapped BTC'),
    new Token(ChainId.APTOS, WBTC_ADDRESS[ChainId.APTOS], 6, 'WBTC', 'Wrapped BTC'),
  ],
};
